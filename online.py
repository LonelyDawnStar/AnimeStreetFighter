...
STATIC_FILES={'/allmight-art.js':'allmight-art.js','/motion.js':'motion.js','/acheron-art.js':'acheron-art.js','/gojo-art.js':'gojo-art.js','/':'index.html',**{'/'+name:name for name in (
