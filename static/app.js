...
Object.assign(defs,{iskandar:{name:'이스칸다르',cls:'RIDER',color:'#e6aa62',style:'중량 · 돌격',desc:'L: 검을 앞세운 돌격 · 피해 22. 보구: 왕의 군세 · 군대와 함께 돌진',np:'IONIOI HETAIROI'},medusa:{name:'메두사',cls:'RIDER',color:'#bf99ec',style:'기동 · 사슬 견제',desc:'L: 사슬 단검 투척 · 피해 14. 보구: 벨레로폰 · 페가수스 돌진',np:'BELLEROPHON'}});
...
function drawRoster(t){for(const {id,canvas}of rosterCanvases){const g=canvas.getContext('2d');g.clearRect(0,0,300,220);GrailArt.fighter(g,{char:id,x:135,y:0,face:1,action:'idle',anim:0},t,.88,216)}}
