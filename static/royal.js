'use strict';
(()=>{
 const stats={saber:[270,120,10],archer:[290,112,9],lancer:[295,138,8],gil:[240,95,8],iskandar:[245,125,11],medusa:[310,118,8]};
 ...
 function render(now){
  if(!state&&GrailArt.ready&&now-lastDraw>100){lastDraw=now;
   ...
   const g=$('selectedArt').getContext('2d');g.clearRect(0,0,240,190);g.imageSmoothingEnabled=false;GrailArt.fighter(g,{char:selected,x:120,y:0,action:'idle',moving:false,face:1},now/1000,.7,185);
